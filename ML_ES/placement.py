...
def overlap_repulsion_loss(cell_features, pin_features, edge_list):
    ...
    This implementation uses a vectorized pairwise overlap proxy that:
    ...
    normalized_overlap = overlap_area.sum() / total_area

    return normalized_overlap + 0.1 * overlap_area.square().mean()
